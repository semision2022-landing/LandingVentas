...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: '5.000 documentos electrónicos con habilitación DIAN GRATIS en 48h. Software avalado por la DIAN para Colombia.',
      sku: 'EMISION-PLAN-X',
      image: 'https://ventas.emision.co/og-image.jpg',
      brand: { '@type': 'Brand', name: 'e-Misión' },
      review: {
        '@type': 'Review',
        reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5' },
        author: { '@type': 'Organization', name: 'e-Misión' },
      },
      aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '127' },
      offers: {
        '@type': 'Offer',
        url: 'https://ventas.emision.co/#planes',
        price: '620000',
        priceCurrency: 'COP',
        priceValidUntil: '2026-12-31',
        availability: 'https://schema.org/InStock',
        seller: { '@type': 'Organization', name: 'e-Misión' },
      },
    },
    {
      '@type': 'Product',
      name: 'Plan Plus — Facturación e-Misión Integral',
      description: '8.000 documentos electrónicos + Nómina electrónica hasta 15 empleados + Recepción R500. Avalado DIAN.',
      sku: 'EMISION-PLAN-PLUS',
      image: 'https://ventas.emision.co/og-image.jpg',
      brand: { '@type': 'Brand', name: 'e-Misión' },
      review: {
        '@type': 'Review',
  ...
  return (
    <html lang="es-CO" className={poppins.variable}>
      ...
      <body className={`${poppins.className} antialiased`}>
        ...
        {/* Google Ads */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-10987711260"
